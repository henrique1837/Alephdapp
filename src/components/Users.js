          ...
          <Col lg={4} style={{height: '500px',overflowY:'scroll'}}>
        {
          this.state.users.map(function(profile){
            ...
            if(profile.name || profile.description){
              div_profile = <div>
                                    <p><small>Alephdapp profile</small></p>
                                    <p>Name: {profile.name}</p>
                                    <p>Description: {profile.description}</p>
                                    <p>Techs: {profile.techs}</p>
                                  </div>
            }
            if((!profile.name || !profile.description) && profile.techs){
              div_profile = <div>
                                    <p><small>Alephdapp profile</small></p>
                                    <p>Techs: {profile.techs}</p>
                                  </div>
            ...
            return(
                ...
                <div>
                    ...
                    <Col lg={12}>
                      ...
                      <Col lg={12}>
                      {div_profile}
                      <Button variant="primary" href={"#user_"+profile.address} onClick={()=>{ that.renderUserPage(profile) }}>Profile</Button>
                      </Col>
                    <hr/>
                    </Row>
